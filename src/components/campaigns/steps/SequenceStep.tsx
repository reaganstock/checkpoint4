...
import { ArrowLeft, Plus, MessageSquare, Clock, ChevronDown, Wand2 } from 'lucide-react';
...
export function SequenceStep({ data, updateData, onNext, onBack }: SequenceStepProps) {
  ...
  const handleContinue = () => {
    ...
    const isValid = messages.every(msg => {
      if (msg.type !== 'message' || !msg.variants || msg.variants.length === 0) return true;
        ...
        <div className="col-span-4 space-y-4">
          {messages.map((message, index) => (
            ...
            >
              ...
              {message.type === 'message' && message.variants && message.variants.length > 0 && (
